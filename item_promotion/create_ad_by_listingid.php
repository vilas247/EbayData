...
if(isset($_REQUEST['bidPercentage']) && isset($_REQUEST['listingId'])){
$postData = array(
	            "bidPercentage" => $_REQUEST['bidPercentage'],
...
if(isset($_REQUEST['campaignId'])){
	$url_T = "https://api.ebay.com/sell/marketing/v1/ad_campaign/".$_REQUEST['campaignId']."/ad"; 
}else{
