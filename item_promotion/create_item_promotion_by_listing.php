...
*/
if(isset($_REQUEST['listingIds']) && isset($_REQUEST['multibuy2']) && isset($_REQUEST['multibuy3']) && isset($_REQUEST['multibuy4'])){
$postData = array(
	            "marketplaceId" => "EBAY_GB",
				"startDate" => "2017-02-11T19:58:18.918Z",
				"endDate" => "2017-03-11T19:58:18.918Z",
				"name" => "Buy 1 and get 2nd one 5% off -part 2",
				"description" => "Buy 1 and get 2nd one 5% off",
				"promotionStatus" => "DRAFT",
	            "inventoryCriterion" => array(
											"listingIds"=> array("142250172493"),
				...
				"discountRules" => array(
										array(
											...
											"discountBenefit" => array(
																	"percentageOffItem" => $_REQUEST['multibuy2']
																)
										),
										array(
											"discountSpecification" => array(
											...
											"discountBenefit" => array(
																	"percentageOffOrder" => $_REQUEST['multibuy3']
																),
											"ruleOrder" => 1,
										),
										,
										array(
											...
											"discountBenefit" => array(
																	"percentageOffOrder" => $_REQUEST['multibuy4']
																),
											"ruleOrder" => 2,
										),
									)
