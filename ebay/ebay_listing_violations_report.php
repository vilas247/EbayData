      ...
      <div class="container-fluid" style="min-height: 0;">
		...
		<div class="row mar-top-0">
			<div class="col-lg-6 form-group">
				...
				<form action="<?= BASE_URL ?>ebay/ebay_listing_violations_report.php" method="GET" >
				<div class="col-md-5">
					<input type="hidden" name="seller_ebay_id" value="<?= $seller_ebay_id ?>" />
					<select class="form-control"name="compliance_type" id="compliance_type">
						<option value="" >Select</option>
...
var compliance_type = "<?= isset($_REQUEST['compliance_type'])?$_REQUEST['compliance_type']:'HTTPS'?>";
...
function change_limit_data(limit){
	...
	var c_type = $('#compliance_type').val();
	if(c_type == ""){
		c_type = "HTTPS";
	}
	$('#violations_report').DataTable({
        ...
        "serverSide": true,
        "ajax": {
			"url": app_base_url+"ebay/scripts/listing_violations_processing.php?seller_ebay_id=<?= $seller_ebay_id ?>&compliance_type="+compliance_type,
			dataFilter: function(data){
				var json = jQuery.parseJSON( data );
				$('#lat_updated_date').html('Report Last Updated: '+json.lastUpdatedDate);
				return data;
			},
		}
	});
