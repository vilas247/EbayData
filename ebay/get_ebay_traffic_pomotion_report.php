...
function change_limit_data(limit){
	...
	$('#traffic_promotion').DataTable({
        ...
        "serverSide": true,
        "ajax": {
			"url": app_base_url+"ebay/scripts/traffic_report_processing.php?seller_ebay_id=<?= $seller_ebay_id ?>",
...
function eBay_addrate(){
	$("body .ebay_suggested_addrate").each(function() {
		var id = $(this).attr('id');
...
$(document).ready(function(){
	$('body').on('change','.select-aspect,.select_ebay_value,.multi_buy2,.multi_buy3,.multi_buy4',function(){
