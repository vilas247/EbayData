		...
		<div class="container-fluid" style="min-height: 0;display:none">
			...
			<div class="row mar-top-0">
				<div class="col-md-12">
					...
					<div class="row" id="total_products">
						<div class="col-lg-10">
							<div style="padding: 0px 15px;display:flex;">
								...
								&nbsp;<div id="skus_selected" style="display:flex">No.of Selected SKU's: <p id="seleted_skus">0</p></div>
							</div>
						</div>
...
$(document).ready(function(){
	...
	$('body').on('click','.inventory_tabs li',function() {
		...
		if($(this).data('val') == "101"){
			$('#skus_selected').addClass('hide');
		}else{
			$('#skus_selected').removeClass('hide');
		}
