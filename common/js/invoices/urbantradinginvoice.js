function UrbanTradingInvoice(data,iUTParam) {
	...
	for (var j = 0; j < data.length; j++) {
		...
		/*totalprice */
			$('#totalprice_ppi').text(X247Invoices.subtotal(j,data[j].orderitems));
		...
		// doc.text("Royal Mail 2nd Class", 70, doc.autoTableEndPosY() + 77);
		...
		var utfinaltot = 0.00;
		utfinaltot = parseFloat(parseFloat(utnetotot) + parseFloat(utvat)).toFixed(2);
