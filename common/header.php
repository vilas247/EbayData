...
<head>
	...
	<script type="text/javascript">var dbcode = "<?= isset($_SESSION['dbcode'])?$_SESSION['dbcode']:'' ?>";</script><!-- Dont remove this dependent in js file-->
	...
	<link rel="stylesheet" type="text/css" href="<?= BASE_URL ?>common/css/datatable/fixed-header.css">
	...
	<script type="text/javascript" charset="utf8" src="<?= BASE_URL ?>common/js/datatable/fixed-header.js"></script>
	<script type="text/javascript" charset="utf8" src="<?= BASE_URL ?>common/js/datatable/datatable-responsive.js"></script>
	<script>
		$.ajax({
				type: 'GET',
				url: app_base_url + 'php_session/check_session_status.php',
				//dataType: 'json',
				success: function (res) {
					res = JSON.parse(res);
					if(!res.status){
						$('#changeDB').show();
						var url = app_base_url+"#/app/login";
					...
					<div class="nav-wrapper" style="height: 55px;">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown display-li" style="min-height: 55px">
								<a href="<?= BASE_URL ?>" data-toggle="dropdown" id="arrow-top-navi" class="service-button" style="padding-bottom: 11px !important; font-size: 15px; padding-right: 22px; margin: 0px">
							...
							<div id="cart" class="top-draganddrop">
								<ul id="horizontal1" class="quickLinkAdd ui-droppable">
			                            ...
			                            <li id="scanpackship" style="">
			                                <a href="<?= BASE_URL ?>#/app/scan-pack-ship" rel="Scan, Pack and Ship" class="ng-binding">Scan, Pack and Ship </a>
			                            </li>
			                            <li id="inventoryhub">
			                                <a href="<?= BASE_URL ?>#/app/inventory-dashboard" rel="Inventory Hub (Common Inventory)" class="ng-binding">Inventory Hub (Common Inventory) </a>
			                            </li>
								</ul>
							</div>
						</div>
								...
								<ul class="dropdown-menu dropdown-menu-user">
									<li>
										<div class="list-group">
											<a class="list-group-item" id="changeDB" style="display:none" style="" data-toggle="modal" data-target="#myModal">
												<div class="media">
													<div class="pull-left">
											...
											<a href="#" id="editAccount" class="list-group-item">
												<div class="media">
													<div class="pull-left">
											...
											<a href="<?= BASE_URL ?>#/app/change-password" class="list-group-item">
												<div class="media">
													<div class="pull-left">
											...
											<fieldset>
												<div class="form-group">
													...
													<div class="col-sm-8 media-arrow-div dropdown-arrow" id="select-arrow">
														<select id="vendorcode" name="dbcode" class="chosen-select form-control" required style="">
														</select>
													</div>
												</div>
											</fieldset>
