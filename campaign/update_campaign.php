...
if(isset($_REQUEST['campaignName']) && isset($_REQUEST['startDate']) && isset($_REQUEST['endDate'])){
$postData = array(
...
if(isset($_REQUEST['campaignId'])){
	$url_T = "https://api.ebay.com/sell/marketing/v1/ad_campaign/".$_REQUEST['campaignId']."/update_campaign_identification"; 
}else{
